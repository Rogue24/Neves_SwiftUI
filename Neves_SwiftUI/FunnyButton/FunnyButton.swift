...
private extension FunnyButton {
    ...
    func _executeActions() {
        guard let actions = getActions?(), actions.count > 0 else { return }
...
internal extension FunnyButton {
    func updateSafeFrame(_ safeFrame: CGRect) {
