...
let beauties = [
    Beauty(
        ...
        image: UIImage.jp.fromBundle("Girl1", type: "jpg")!,
        alignment: .center,
        show: false,
        index: -1
    ),
    Beauty(
        ...
        image: UIImage.jp.fromBundle("Girl2", type: "jpg")!,
        alignment: .center,
        show: false,
        index: -1
    ),
    Beauty(
        ...
        image: UIImage.jp.fromBundle("Girl3", type: "jpg")!,
        alignment: .top,
        show: false,
        index: -1
    ),
    Beauty(
        ...
        image: UIImage.jp.fromBundle("Girl4", type: "jpg")!,
        alignment: .center,
        show: false,
        index: -1
    ),
    Beauty(
        ...
        image: UIImage.jp.fromBundle("Girl5", type: "jpg")!,
        alignment: .top,
        show: false,
        index: -1
    ),
    Beauty(
        ...
        image: UIImage.jp.fromBundle("Girl6", type: "jpg")!,
        alignment: .top,
        show: false,
        index: -1
    ),
    Beauty(
        ...
        image: UIImage.jp.fromBundle("Girl7", type: "jpg")!,
        alignment: .center,
        show: false,
        index: -1
    ),
    Beauty(
        ...
        image: UIImage.jp.fromBundle("Girl8", type: "jpg")!,
        alignment: .center,
        show: false,
        index: -1
    )
