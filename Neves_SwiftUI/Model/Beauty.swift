...
let beauties = [
    Beauty(
        ...
        image: UIImage(contentsOfFile: Bundle.main.path(forResource: "Girl1", ofType: "jpg")!)!,
        alignment: .center,
        show: false,
        index: -1
    ),
    Beauty(
        ...
        image: UIImage(contentsOfFile: Bundle.main.path(forResource: "Girl2", ofType: "jpg")!)!,
        alignment: .center,
        show: false,
        index: -1
    ),
    Beauty(
        ...
        image: UIImage(contentsOfFile: Bundle.main.path(forResource: "Girl3", ofType: "jpg")!)!,
        alignment: .top,
        show: false,
        index: -1
    ),
    Beauty(
        ...
        image: UIImage(contentsOfFile: Bundle.main.path(forResource: "Girl4", ofType: "jpg")!)!,
        alignment: .center,
        show: false,
        index: -1
    ),
    Beauty(
        ...
        image: UIImage(contentsOfFile: Bundle.main.path(forResource: "Girl5", ofType: "jpg")!)!,
        alignment: .top,
        show: false,
        index: -1
    ),
    Beauty(
        ...
        image: UIImage(contentsOfFile: Bundle.main.path(forResource: "Girl6", ofType: "jpg")!)!,
        alignment: .top,
        show: false,
        index: -1
    ),
    Beauty(
        ...
        image: UIImage(contentsOfFile: Bundle.main.path(forResource: "Girl7", ofType: "jpg")!)!,
        alignment: .center,
        show: false,
        index: -1
    ),
    Beauty(
        ...
        image: UIImage(contentsOfFile: Bundle.main.path(forResource: "Girl8", ofType: "jpg")!)!,
        alignment: .center,
        show: false,
        index: -1
    )
