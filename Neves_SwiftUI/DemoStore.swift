...
//                .environment(\.catApiManager, .shared)
        ...
        // Base
        case .StateStorage: StateStorageView()
        ...
        case .PhaseAnimBall: PhaseAnimBallView()
        ...
        case .TestArc_V: TestArcView(isUseVStack: true)
        case .TestArc_Z: TestArcView(isUseVStack: false)
        }
    }
}
